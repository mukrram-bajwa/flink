 ...
 */
public class UndirectEdgeFlatMapDriver<IT, OT> implements Driver<FlatMapFunction<IT, OT>, OT> {

	private static final Logger LOG = LoggerFactory.getLogger(UndirectEdgeFlatMapDriver.class);
	...
	public void run() throws Exception {
		...
		final FlatMapFunction<IT, OT> function = (FlatMapFunction<IT, OT>) new UndirectEdge();

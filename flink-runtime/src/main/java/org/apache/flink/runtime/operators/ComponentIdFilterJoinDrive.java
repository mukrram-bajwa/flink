 ...
 */
public class ComponentIdFilterJoinDrive<IT1, IT2, OT> implements Driver<FlatJoinFunction<IT1, IT2, OT>, OT> {
	
	protected static final Logger LOG = LoggerFactory.getLogger(ComponentIdFilterJoinDrive.class);
	...
	public void run() throws Exception {
		...
		final FlatJoinFunction<IT1, IT2, OT> joinStub = (FlatJoinFunction<IT1, IT2, OT>) new ComponentIdFilter();
		final CountingCollector<OT> collector = new CountingCollector<>(this.taskContext.getOutputCollector(), numRecordsOut);

 ...
 */
public class FlatMapDriver6<IT, OT> implements Driver<FlatMapFunction<IT, OT>, OT> {

	private static final Logger LOG = LoggerFactory.getLogger(FlatMapDriver6.class);
	...
	public void run() throws Exception {
		...
		final FlatMapFunction<IT, OT> function = (FlatMapFunction<IT, OT>) new FlatMap6();

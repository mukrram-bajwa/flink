 ...
 */
public class BuildOutgoingEdgeListGroupReduceDriver<IT, OT> implements Driver<GroupReduceFunction<IT, OT>, OT> {
	
	private static final Logger LOG = LoggerFactory.getLogger(BuildOutgoingEdgeListGroupReduceDriver.class);
	...
	public void run() throws Exception {
		...
		final GroupReduceFunction<IT, OT> stub = (GroupReduceFunction<IT, OT>) new BuildOutgoingEdgeList();
		final CountingCollector<OT> output = new CountingCollector<>(this.taskContext.getOutputCollector(), numRecordsOut);

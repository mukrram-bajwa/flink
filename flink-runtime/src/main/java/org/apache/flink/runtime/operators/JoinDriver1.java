 ...
 */
public class JoinDriver1<IT1, IT2, OT> implements Driver<FlatJoinFunction<IT1, IT2, OT>, OT> {
	
	protected static final Logger LOG = LoggerFactory.getLogger(JoinDriver1.class);
	...
	public void run() throws Exception {
		...
		final FlatJoinFunction<IT1, IT2, OT> joinStub = (FlatJoinFunction<IT1, IT2, OT>) new FlatJoin1();

 ...
 * @see ReduceFunction
 */
public class ReduceDriver3<T> implements Driver<ReduceFunction<T>, T> {
	
	private static final Logger LOG = LoggerFactory.getLogger(ReduceDriver3.class);
	...
	public void run() throws Exception {
		...
		final ReduceFunction<T> function = (ReduceFunction<T>) new Reduce3();

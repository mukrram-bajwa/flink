 ...
 * @see ReduceFunction
 */
public class ReduceDriver1<T> implements Driver<ReduceFunction<T>, T> {
	
	private static final Logger LOG = LoggerFactory.getLogger(ReduceDriver1.class);
	...
	public void run() throws Exception {
		...
		final ReduceFunction<T> function = (ReduceFunction<T>) new Reduce1();

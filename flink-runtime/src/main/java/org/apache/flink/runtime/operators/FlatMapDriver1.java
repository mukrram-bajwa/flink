 ...
 */
public class FlatMapDriver1<IT, OT> implements Driver<FlatMapFunction<IT, OT>, OT> {

	private static final Logger LOG = LoggerFactory.getLogger(FlatMapDriver1.class);
	...
	public void run() throws Exception {
		...
		final FlatMapFunction<IT, OT> function = (FlatMapFunction<IT, OT>) new FlatMap1();

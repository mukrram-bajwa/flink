 ...
 */
public class DuplicatevalueMapDriver<IT, OT> implements Driver<MapFunction<IT, OT>, OT> {
	...
	public void run() throws Exception {
		...
		final MapFunction<IT, OT> function = (MapFunction<IT, OT>)new DuplicateValue();
